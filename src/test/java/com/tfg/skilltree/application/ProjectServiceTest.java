...
import com.tfg.skilltree.application.implement.ProjectServiceImpl;
...
class ProjectServiceTest {
    ...
    void testSave(){
        when(projectRepository.save(ProjectFixtures.PROJECT_BY_CODE)).thenReturn(ProjectFixtures.PROJECT_BY_CODE);
        Project result = projectService.create(ProjectFixtures.PROJECT_BY_CODE);
        assertThat(result).isEqualTo(ProjectFixtures.PROJECT_BY_CODE);
    }

    @Test
    @DisplayName("Test save exception")
    void testSaveException(){
        when(projectRepository.findByCode(anyString())).thenReturn(ProjectFixtures.PROJECT_BY_CODE);
        Assertions.assertThrows(EntityFoundException.class, () ->
                projectService.create(ProjectFixtures.PROJECT_BY_CODE)
        );
    }
    ...
    void testGetAll(){
        when(projectRepository.findAll()).thenReturn(ProjectFixtures.PROJECT_LIST);
        List<Project> result = projectService.getAll();
        assertThat(result).containsExactly(ProjectFixtures.PROJECT_BY_CODE, ProjectFixtures.PROJECT2_BY_CODE);
    }
    ...
    void testFindByCodeExceptionDeleted(){
        when(projectRepository.findByCode(anyString())).thenReturn(ProjectFixtures.PROJECT_BY_CODE_DELETED_TRUE);
        Assertions.assertThrows(EntityNotFoundException.class, () ->
                projectService.findByCode("1")
        );
    }
    ...
    void testDeleteByCode() {
        ...
        when(projectRepository.findByCode("1")).thenReturn(ProjectFixtures.PROJECT_BY_CODE);
    ...
    void testFindProject() {
        when(projectRepository.findProject(anyString())).thenReturn(ProjectFixtures.PROJECT_BY_CODE);
    ...
    void testFindProjectExceptionDeleted(){
        when(projectRepository.findProject(anyString())).thenReturn(ProjectFixtures.PROJECT_BY_CODE_DELETED_TRUE);
        Assertions.assertThrows(EntityNotFoundException.class, () ->
                projectService.findProject("1")
        );
    }
