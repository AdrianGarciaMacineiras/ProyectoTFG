...
public record People(Long code, String employeeId, String name, String surname, LocalDate birthDate, EnumTitle title,
                     ...
                     List<Skill> interest, List<Certificate> certificates, List<Assignments> assigns, boolean deleted,
                     boolean assignable, List<String> noClients, List<String> noProjects) {
}
